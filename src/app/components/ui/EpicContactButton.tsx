    ...
    >
      ...
      >
        ...
        <div className="absolute -inset-[2px] rounded-lg overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-blue-500 to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity" style={{
        ...
        <Link href="/kontakt">
          <motion.button
            ref={buttonRef}
            className="relative z-10 bg-white text-black font-medium py-3 px-8 rounded-lg overflow-hidden flex items-center gap-2 cursor-pointer"
          ...
          >
            ...
            >
              <motion.span variants={textVariants}>Kontakt oss</motion.span>
              <motion.div
...
export default EpicContactButton;