        ...
        <div className="bg-gradient-to-br from-blue-950 to-blue-900 rounded-xl p-8 text-white">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="tel:+4712345678" className="text-blue-200 hover:text-white transition-colors">+91 14 49 19</a>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-blue-200">Kvennhusvegen 21, 2820 Nordre Toten</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-10 pt-6 border-t border-blue-800">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/baadstad/?locale=nb_NO" target="_blank" rel="noopener noreferrer" className="bg-blue-800 hover:bg-blue-700 p-3 rounded-full transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/baadstad/" target="_blank" rel="noopener noreferrer" className="bg-blue-800 hover:bg-blue-700 p-3 rounded-full transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
